...
#   timestamp: 2026-05-29T11:40:38+00:00
...
class GoogleCallbackRequest(BaseModel):
    code: Annotated[str, Field(description='Authorization code from Google OAuth')]
    ...
    code_verifier: Annotated[
        str | None,
        Field(description='PKCE code verifier (required when PKCE was used)'),
    ] = None
...
class GroupMemberFamily(BaseModel):
    ...
    admin_user_ids: Annotated[
        list[UUID],
        Field(description='Parents in this family who hold group admin rights'),
    ]
    joined_at: AwareDatetime
