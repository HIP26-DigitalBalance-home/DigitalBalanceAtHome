...
#   timestamp: 2026-07-08T16:56:37+00:00
...
class ActivityResourcePhoto(BaseModel):
    id: UUID
    status: Status
    position: Annotated[int, Field(ge=0)]
    photo_url: Annotated[
        str | None,
        Field(description="Pre-signed GET URL (15-min TTL); present only when status=ready"),
    ] = None
...
class ActivityResource(BaseModel):
    ...
    url: Annotated[
        str | None,
        Field(description="Present for external resources (http/https)", max_length=2048),
    ] = None
    note_text: Annotated[str | None, Field(description="Present for internal resources", max_length=2000)] = None
    photos: Annotated[
        list[ActivityResourcePhoto] | None,
        Field(description="Present for internal resources"),
    ] = None


class ActivityDetail(Activity):
    can_edit: Annotated[bool, Field(description="True when the caller's family owns the activity")]
    resources: list[ActivityResource]
...
class CreateResourceRequest(BaseModel):
    ...
    url: Annotated[
        str | None,
        Field(
            description="Required when kind=external; must be http/https",
            max_length=2048,
        ),
    ] = None
    note_text: Annotated[
        str | None,
        Field(
            description="Required (non-empty) when kind=internal on this JSON path",
            max_length=2000,
        ),
    ] = None
...
class UpdateResourceRequest(BaseModel):
    ...
    note_text: Annotated[str | None, Field(max_length=2000)] = None
...
class UpsertManualTimeRequest(BaseModel):
    ...
    entry_date: Annotated[
        date_aliased,
        Field(description="Parent's local calendar date; active UI sends local today"),
    ]
...
class DailyTimeTotal(BaseModel):
    ...
    manual_minutes: Annotated[int, Field(ge=0)]
...
class AverageWeeklyMinutes(RootModel[int]):
    root: Annotated[
        int,
        Field(
...
class JournalEntry(BaseModel):
    ...
    entry_date: Annotated[
        date_aliased,
        Field(description="The user's local calendar date the mood refers to"),
    ]
    mood: Mood
    created_at: AwareDatetime
...
class CreatedActivity(BaseModel):
    id: UUID
    title: str
    description: str | None = None
    resources: list[ActivityResource]
...
class DataExport(BaseModel):
    ...
    created_activities: Annotated[
        list[CreatedActivity] | None,
        Field(description="Activities created by the user's family, including their attached resources"),
    ] = None
