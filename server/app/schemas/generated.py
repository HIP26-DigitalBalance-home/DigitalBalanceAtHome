...
#   timestamp: 2026-06-28T11:25:20+00:00
...
class StreakStats(BaseModel):
    current_weeks: Annotated[int, Field(examples=[4], ge=0)]
    last_weeks: Annotated[int | None, Field(examples=[None])] = None
    longest_weeks: Annotated[int, Field(examples=[6], ge=0)]
    frozen_this_week: Annotated[bool, Field(examples=[False])]
