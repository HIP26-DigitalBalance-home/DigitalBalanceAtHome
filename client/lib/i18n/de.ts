...
export const de = {
  ...
  completeModal: {
    ...
    durationQuestion: 'Wie lange wart ihr aktiv?',
    durationRequired: 'Bitte wähle aus, wie lange ihr aktiv wart.',
    durationMinutes: '{{count}} Min',
    durationMinutesPlus: '{{count}}+ Min',
    customDuration: 'Eigene',
    customMinutesPlaceholder: 'Minuten (1–1440)',
    invalidDuration: 'Gib eine ganze Zahl zwischen 1 und 1440 ein.',
  ...
  resources: {
    sectionTitle: 'HILFREICHE INFOS',
    toggle: 'Hilfreiche Infos ({{count}})',
    sectionHint: 'Spart der Familie Vorbereitung – z. B. ein Rezept-Link oder eine kurze Notiz.',
    addButton: 'Info hinzufügen',
    none: 'Noch keine Infos hinzugefügt.',
    chooseType: 'Was möchtest du hinzufügen?',
    linkOption: '🔗 Link',
    noteOption: '📝 Notiz',
    linkUrlLabel: 'LINK-ADRESSE',
    linkUrlPlaceholder: 'https://…',
    linkLabelLabel: 'BESCHRIFTUNG (optional)',
    linkLabelPlaceholder: 'z. B. Unser Rezept',
    noteLabel: 'NOTIZ',
    notePlaceholder: 'z. B. Wir nehmen die Hälfte Zucker.',
    addPhoto: '📷 Foto hinzufügen',
    changePhoto: 'Foto ändern',
    photoSelected: 'Foto ausgewählt',
    externalHint: 'Öffnet eine externe Website',
    processing: 'Foto wird verarbeitet …',
    invalidUrl: 'Bitte gib eine gültige http(s)-Adresse ein.',
    emptyNote: 'Bitte gib einen Text ein oder füge ein Foto hinzu.',
    save: 'Übernehmen',
    cancel: 'Abbrechen',
    remove: 'Entfernen',
  ...
  verification: {
    ...
    verified: 'Bestätigt',
    rejected: 'Foto abgelehnt',
    rejectionReason: 'Grund der Ablehnung',
    noReason: 'Kein Grund angegeben.',
    reupload: 'Bitte lade ein neues Foto hoch, um diese Aktivität abzuschließen.',
    reuploadButton: 'Neues Foto hochladen',
    selectedPhoto: 'Ausgewähltes Foto',
    pointsPending: '+{{count}} Punkte nach Bestätigung',
    pointsEarned: '+{{count}} Punkte erhalten',
    slotPending: '{{title}} – wird geprüft',
    slotRejected: '{{title}} – Foto abgelehnt, tippen zum erneuten Hochladen',
  },
  rewards: {
    title: 'Prämien',
    quarterBalance: 'Punkte dieses Quartal',
    quarterLabel: 'Quartal {{key}}',
    levelLabel: 'Level {{number}}',
    pointsProgress: '{{balance}} / {{threshold}} Punkte',
    locked: 'Noch gesperrt',
    unlocked: 'Freigeschaltet',
    alreadyRedeemed: 'Dieses Quartal bereits eingelöst',
    redeem: 'Einlösen',
    redeemSuccessTitle: 'Prämie eingelöst! 🎉',
    redeemSuccessMessage: 'Dein Gutscheincode: {{code}}',
    voucherCode: 'Gutscheincode',
    chooseOption: 'Wähle eine Option',
    annualCapStatus: '{{used}} von {{cap}} dieses Jahr eingelöst',
    annualCapReached: 'Jahreslimit erreicht',
    infoNote: 'Punkte sammelt ihr durch bestätigte Aktivitäten. Der Punktestand startet jedes Quartal neu — Einlösen verringert ihn nicht.',
    options: {
      supermarket_voucher: 'Supermarktgutschein',
      streaming_month: 'Ein Monat Streaming (Disney+/Netflix)',
    },
  },
  verificationQueue: {
    title: 'Fotos prüfen',
    openQueue: 'Fotos prüfen',
    empty: 'Keine Fotos zur Prüfung – alles erledigt! 🎉',
    pendingCount: '{{count}} Foto(s) warten auf Prüfung',
    approve: 'Freigeben',
    reject: 'Ablehnen',
  ...
  timeSpent: {
    sectionLabel: 'ZEIT MIT DEINEM KIND',
    weekly: 'Woche',
    monthly: 'Monat',
    previousPeriod: 'Vorheriger Zeitraum',
    nextPeriod: 'Nächster Zeitraum',
    averagePerDay: 'Durchschnitt pro Tag: {{value}}',
    empty: 'Eure gemeinsame Zeit erscheint hier.',
    dailyBar: '{{date}}: {{value}}',
    weeklyBar: '{{start}} bis {{end}}: durchschnittlich {{value}} pro Tag',
