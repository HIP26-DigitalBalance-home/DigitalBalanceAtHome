...
export const en = {
  ...
  completeModal: {
    ...
    customMinutesPlaceholder: 'Minutes (1–1440)',
  ...
  resources: {
    sectionTitle: 'HELPFUL INFO',
    toggle: 'Helpful info ({{count}})',
    sectionHint: 'Saves the family prep time — e.g. a recipe link or a short note.',
    addButton: 'Add info',
    none: 'No info added yet.',
    chooseType: 'What do you want to add?',
    linkOption: '🔗 Link',
    noteOption: '📝 Note',
    linkUrlLabel: 'LINK ADDRESS',
    linkUrlPlaceholder: 'https://…',
    linkLabelLabel: 'LABEL (optional)',
    linkLabelPlaceholder: 'e.g. Our recipe',
    noteLabel: 'NOTE',
    notePlaceholder: 'e.g. We use half the sugar.',
    addPhoto: '📷 Add photo',
    changePhoto: 'Change photo',
    photoSelected: 'Photo selected',
    externalHint: 'Opens an external website',
    processing: 'Processing photo …',
    invalidUrl: 'Please enter a valid http(s) address.',
    emptyNote: 'Please enter some text or add a photo.',
    save: 'Add',
    cancel: 'Cancel',
    remove: 'Remove',
  ...
  timeSpent: {
    sectionLabel: 'TIME WITH YOUR CHILD',
    weekly: 'Weekly',
    monthly: 'Monthly',
    previousPeriod: 'Previous period',
    nextPeriod: 'Next period',
    averagePerDay: 'Average per day: {{value}}',
    empty: 'Your time together will appear here.',
    dailyBar: '{{date}}: {{value}}',
    weeklyBar: '{{start}} to {{end}}: {{value}} per day on average',
