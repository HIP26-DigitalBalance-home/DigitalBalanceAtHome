...
export default function EditChildScreen() {
  ...
  const initialInterests = interests ? interests.split(',').filter(Boolean) : [];
        ...
        {({ handleChange, handleBlur, handleSubmit: submit, setFieldValue, values, errors, touched, isSubmitting, status }) => (
          <>
            <View style={[styles.header, { borderBottomColor: colors.border }]}>
              ...
              <ThemedText type="title" style={styles.title}>{t('editChild.title')}</ThemedText>
            </View>
            ...
            <View style={styles.footer}>
              <Pressable
                ...
                {isSubmitting ? (
                  ...
                  <ThemedText style={[styles.buttonText, { color: '#fff' }]}>{t('common.save')}</ThemedText>
                )}
              </Pressable>
            </View>
          </>
